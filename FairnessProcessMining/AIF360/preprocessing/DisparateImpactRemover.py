...
from AIF360.preprocessing.DisparateImpactRemover import DisparateImpactRemover
...
def PreDisparateImpactRemoverRandomFlorestOptuna(X_train, y_train, X_test, y_test, df_train, df_test, protected_attribute, num_trials=50):
    """
    This funcion applies the AIF360 Disparate Impact Remover (DIR) pre-processing technique to the training dataset and then 
